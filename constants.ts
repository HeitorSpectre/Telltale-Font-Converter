...
export const CHAR_MAP: { [key: number]: string } = {
  32: ' ', // Added Space as it's common and was missing
  ...
  120: 'x', 121: 'y', 122: 'z', 123: '{', 124: '|', 125: '}', 126: '~', 128: '€',
  130: '‚', 131: 'ƒ', 132: '„', 133: '…', 134: '†', 135: '‡', 136: 'ˆ', 137: '‰',
  138: 'Š', 139: '‹', 140: 'Œ', 142: 'Ž', 145: '‘',
  146: '’', 147: '“', 148: '”', 149: '•', 150: '–', 151: '—', 152: '˜', 153: '™',
  154: 'š',
  155: '›', 156: 'œ',158: 'ž', 159: 'Ÿ', 161: '¡', 162: '¢',
...
export const CHAR_SET_NAMES = ['Uppercase', 'Lowercase', 'Numbers', 'Basic Punct.', 'Accented Latin'] as const;

export const CHAR_SETS: Record<typeof CHAR_SET_NAMES[number], string> = {
  'Uppercase': "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
  'Lowercase': "abcdefghijklmnopqrstuvwxyz",
  'Numbers': "0123456789",
  'Basic Punct.': " !@#$%^&*()_+-=[]{};':\",./<>?©™®",
  'Accented Latin': "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿ"
};